  ...
  return (
    <>
      ...
      <section
        ...
        aria-label="3D showcase coming soon"
      >
        <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
          <ScrollReveal>
            <div className="flex h-24 w-24 items-center justify-center rounded-full border border-dashed border-muted/60 bg-background">
              <svg
          ...
          <ScrollReveal delay={0.1}>
            <h2 className="mt-8 font-display text-3xl font-bold text-foreground sm:text-4xl">
              3D Бүтээгдэхүүн
            </h2>
            <p className="mt-4 max-w-lg text-lg leading-relaxed text-foreground/60">
              Тун удахгүй — бидний бүтээгдэхүүнийг 3 хэмжээст орон зайд эргүүлж үзэх боломжтой
              болно. Three.js технологиор хийгдэх энэхүү туршлагыг тэсэн ядан хүлээж байна.
            </p>
          </ScrollReveal>

          <ScrollReveal delay={0.2}>
            <div className="mt-10 h-64 w-full max-w-2xl rounded-lg border border-dashed border-muted/40 bg-background/50 flex items-center justify-center">
              <p className="text-sm text-foreground/30">3D showcase — Coming soon</p>
            </div>
          </ScrollReveal>
        </div>
      </section>
