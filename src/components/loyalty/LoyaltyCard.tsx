...
import { type LoyaltyUser, TIERS, type TierConfig } from '@/lib/mock-data'
  ...
  return (
    <div className="loyalty-card relative w-full max-w-md min-w-0 overflow-hidden rounded-2xl border border-accent-gold/30 bg-bg-elevated backdrop-blur-md">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(201,162,75,0.15) 2px, rgba(201,162,75,0.15) 4px)',
        }}
      />
